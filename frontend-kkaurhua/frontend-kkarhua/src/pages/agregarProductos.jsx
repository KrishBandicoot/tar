...
export default function AgregarProducto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const productoCreado = await createProduct(productoData);

      // Si hay imagen, subirla
      if (imagen && productoCreado.id) {
        try {
          await uploadProductImage(productoCreado.id, imagen);
        } catch (imgError) {
              ...
              <form onSubmit={handleSubmit} className="card p-4 shadow">
                ...
                <div className="mb-3">
                  ...
                  <input 
                    ...
                    disabled={loading}
                  />
                  <small className="text-muted">Tamaño máximo: 5MB. Formatos: JPG, PNG, GIF</small>
                  {imagen && (
                    <div className="mt-2">
                      <img 
